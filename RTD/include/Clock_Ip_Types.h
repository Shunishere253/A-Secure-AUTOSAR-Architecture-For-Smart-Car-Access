...
#define CLOCK_IP_TYPES_SW_MAJOR_VERSION                3
...
typedef enum {
    ...
    CLOCK_MONITOR_NOTIFICATIONS    = 0U,   /* Notification is sent on behalf of interrupt service routine from power */
    BEFORE_POWER_MODE_CHANGE       = 1U,   /* Before power mode change command is sent */
    POWER_MODE_CHANGE_IN_PROGRESS  = 2U,   /* Power mode transition is in progress */
    POWER_MODE_CHANGED             = 3U,   /* Power mode transition completed */
...
typedef enum {
    ...
    SYSTEM_DIV4_CLK        = CLOCK_IP_HAS_SYSTEM_DIV4_CLK,
#endif
    ...
    fxosc_clk               = CLOCK_IP_HAS_fxosc_clk,
#endif
#if defined(CLOCK_IP_HAS_ref_clk)
    ref_clk               = CLOCK_IP_HAS_ref_clk,
#endif
#if defined(CLOCK_IP_HAS_crs_eth0_mii_rxclk_ext_clk)
    crs_eth0_mii_rxclk_ext_clk               = CLOCK_IP_HAS_crs_eth0_mii_rxclk_ext_clk,
#endif
#if defined(CLOCK_IP_HAS_crs_eth0_mii_txclk_ext_clk)
    crs_eth0_mii_txclk_ext_clk               = CLOCK_IP_HAS_crs_eth0_mii_txclk_ext_clk,
#endif
#if defined(CLOCK_IP_HAS_crs_eth0_ref_rx_ext_clk)
    crs_eth0_ref_rx_ext_clk               = CLOCK_IP_HAS_crs_eth0_ref_rx_ext_clk,
#endif
#if defined(CLOCK_IP_HAS_crs_eth0_rgmii_txclk_ext_clk)
    crs_eth0_rgmii_txclk_ext_clk               = CLOCK_IP_HAS_crs_eth0_rgmii_txclk_ext_clk,
#endif
#if defined(CLOCK_IP_HAS_crs_eth1_mii_rxclk_ext_clk)
    crs_eth1_mii_rxclk_ext_clk               = CLOCK_IP_HAS_crs_eth1_mii_rxclk_ext_clk,
#endif
#if defined(CLOCK_IP_HAS_crs_eth1_mii_txclk_ext_clk)
    crs_eth1_mii_txclk_ext_clk               = CLOCK_IP_HAS_crs_eth1_mii_txclk_ext_clk,
#endif
#if defined(CLOCK_IP_HAS_crs_eth1_ref_rx_ext_clk)
    crs_eth1_ref_rx_ext_clk               = CLOCK_IP_HAS_crs_eth1_ref_rx_ext_clk,
#endif
#if defined(CLOCK_IP_HAS_crs_eth1_rgmii_txclk_ext_clk)
    crs_eth1_rgmii_txclk_ext_clk               = CLOCK_IP_HAS_crs_eth1_rgmii_txclk_ext_clk,
#endif
#if defined(CLOCK_IP_HAS_crs_tmr_1588_ext_clk)
    crs_tmr_1588_ext_clk               = CLOCK_IP_HAS_crs_tmr_1588_ext_clk,
#endif
#if defined(CLOCK_IP_HAS_crs_tmr_1588_inv_ext_clk)
    crs_tmr_1588_inv_ext_clk               = CLOCK_IP_HAS_crs_tmr_1588_inv_ext_clk,
#endif
#if defined(CLOCK_IP_HAS_fss_avpll0_div2_clk)
    fss_avpll0_div2_clk               = CLOCK_IP_HAS_fss_avpll0_div2_clk,
#endif
#if defined(CLOCK_IP_HAS_fss_avpll1_div2_clk)
    fss_avpll1_div2_clk               = CLOCK_IP_HAS_fss_avpll1_div2_clk,
#endif
#if defined(CLOCK_IP_HAS_fss_avpll1_div3_clk)
    fss_avpll1_div3_clk               = CLOCK_IP_HAS_fss_avpll1_div3_clk,
#endif
#if defined(CLOCK_IP_HAS_fss_avpll1_div4_clk)
    fss_avpll1_div4_clk               = CLOCK_IP_HAS_fss_avpll1_div4_clk,
#endif
#if defined(CLOCK_IP_HAS_fss_avpll1_div5_clk)
    fss_avpll1_div5_clk               = CLOCK_IP_HAS_fss_avpll1_div5_clk,
#endif
#if defined(CLOCK_IP_HAS_fss_ftm_ext1_clk)
    fss_ftm_ext1_clk               = CLOCK_IP_HAS_fss_ftm_ext1_clk,
#endif
#if defined(CLOCK_IP_HAS_fss_ftm_ext2_clk)
    fss_ftm_ext2_clk               = CLOCK_IP_HAS_fss_ftm_ext2_clk,
#endif
#if defined(CLOCK_IP_HAS_RTU3_REF_CLK)
    RTU3_REF_CLK               = CLOCK_IP_HAS_RTU3_REF_CLK,
#endif
#if defined(CLOCK_IP_HAS_SMMS_REF_CLK)
    SMMS_REF_CLK               = CLOCK_IP_HAS_SMMS_REF_CLK,
#endif
#if defined(CLOCK_IP_HAS_CIS_REF_CLK)
    CIS_REF_CLK               = CLOCK_IP_HAS_CIS_REF_CLK,
#endif
#if defined(CLOCK_IP_HAS_CRS_REF_CLK)
    CRS_REF_CLK               = CLOCK_IP_HAS_CRS_REF_CLK,
#endif
#if defined(CLOCK_IP_HAS_RTU0_CORE_DIV4_SECOND_MONITOR_CLK)
    RTU0_CORE_DIV4_SECOND_MONITOR_CLK               = CLOCK_IP_HAS_RTU0_CORE_DIV4_SECOND_MONITOR_CLK,
#endif
#if defined(CLOCK_IP_HAS_RTU0_CORE_DIV4_THIRD_MONITOR_CLK)
    RTU0_CORE_DIV4_THIRD_MONITOR_CLK               = CLOCK_IP_HAS_RTU0_CORE_DIV4_THIRD_MONITOR_CLK,
#endif
#if defined(CLOCK_IP_HAS_RTU0_CORE_DIV8_SECOND_MONITOR_CLK)
    RTU0_CORE_DIV8_SECOND_MONITOR_CLK               = CLOCK_IP_HAS_RTU0_CORE_DIV8_SECOND_MONITOR_CLK,
#endif
#if defined(CLOCK_IP_HAS_RTU0_REF_CLK)
    RTU0_REF_CLK               = CLOCK_IP_HAS_RTU0_REF_CLK,
#endif
#if defined(CLOCK_IP_HAS_RTU1_CORE_DIV4_SECOND_MONITOR_CLK)
    RTU1_CORE_DIV4_SECOND_MONITOR_CLK               = CLOCK_IP_HAS_RTU1_CORE_DIV4_SECOND_MONITOR_CLK,
#endif
#if defined(CLOCK_IP_HAS_RTU1_CORE_DIV4_THIRD_MONITOR_CLK)
    RTU1_CORE_DIV4_THIRD_MONITOR_CLK               = CLOCK_IP_HAS_RTU1_CORE_DIV4_THIRD_MONITOR_CLK,
#endif
#if defined(CLOCK_IP_HAS_RTU1_CORE_DIV8_SECOND_MONITOR_CLK)
    RTU1_CORE_DIV8_SECOND_MONITOR_CLK               = CLOCK_IP_HAS_RTU1_CORE_DIV8_SECOND_MONITOR_CLK,
#endif
#if defined(CLOCK_IP_HAS_RTU1_REF_CLK)
    RTU1_REF_CLK               = CLOCK_IP_HAS_RTU1_REF_CLK,
#endif
#if defined(CLOCK_IP_HAS_RTU2_CORE_DIV4_SECOND_MONITOR_CLK)
    RTU2_CORE_DIV4_SECOND_MONITOR_CLK               = CLOCK_IP_HAS_RTU2_CORE_DIV4_SECOND_MONITOR_CLK,
#endif
#if defined(CLOCK_IP_HAS_RTU2_CORE_DIV4_THIRD_MONITOR_CLK)
    RTU2_CORE_DIV4_THIRD_MONITOR_CLK               = CLOCK_IP_HAS_RTU2_CORE_DIV4_THIRD_MONITOR_CLK,
#endif
#if defined(CLOCK_IP_HAS_RTU2_CORE_DIV8_SECOND_MONITOR_CLK)
    RTU2_CORE_DIV8_SECOND_MONITOR_CLK               = CLOCK_IP_HAS_RTU2_CORE_DIV8_SECOND_MONITOR_CLK,
#endif
#if defined(CLOCK_IP_HAS_RTU2_REF_CLK)
    RTU2_REF_CLK               = CLOCK_IP_HAS_RTU2_REF_CLK,
#endif
...
#endif
#if defined(CLOCK_IP_HAS_RUN_PRI_DIV_SYS_CLK)
    RUN_PRI_DIV_SYS_CLK           =   CLOCK_IP_HAS_RUN_PRI_DIV_SYS_CLK,
#endif
#if defined(CLOCK_IP_HAS_RUN_CORE_CLK)
    RUN_CORE_CLK                  =   CLOCK_IP_HAS_RUN_CORE_CLK,
#endif
#if defined(CLOCK_IP_HAS_RUN_SYS_CLK)
    RUN_SYS_CLK                   =   CLOCK_IP_HAS_RUN_SYS_CLK,
#endif
#if defined(CLOCK_IP_HAS_RUN_FLASH_CLK)
    RUN_FLASH_CLK                 =   CLOCK_IP_HAS_RUN_FLASH_CLK,
#endif
#if defined(CLOCK_IP_HAS_RUN_BUS_CLK)
    RUN_BUS_CLK                   =   CLOCK_IP_HAS_RUN_BUS_CLK,
#endif
#if defined(CLOCK_IP_HAS_HSRUN_PRI_DIV_SYS_CLK)
    HSRUN_PRI_DIV_SYS_CLK         =   CLOCK_IP_HAS_HSRUN_PRI_DIV_SYS_CLK,
#endif
#if defined(CLOCK_IP_HAS_HSRUN_CORE_CLK)
    HSRUN_CORE_CLK                =   CLOCK_IP_HAS_HSRUN_CORE_CLK,
#endif
#if defined(CLOCK_IP_HAS_HSRUN_SYS_CLK)
    HSRUN_SYS_CLK                 =   CLOCK_IP_HAS_HSRUN_SYS_CLK,
#endif
#if defined(CLOCK_IP_HAS_HSRUN_FLASH_CLK)
    HSRUN_FLASH_CLK               =   CLOCK_IP_HAS_HSRUN_FLASH_CLK,
#endif
#if defined(CLOCK_IP_HAS_HSRUN_BUS_CLK)
    HSRUN_BUS_CLK                 =   CLOCK_IP_HAS_HSRUN_BUS_CLK,
#endif
#if defined(CLOCK_IP_HAS_VLPR_PRI_DIV_SYS_CLK)
    VLPR_PRI_DIV_SYS_CLK          =   CLOCK_IP_HAS_VLPR_PRI_DIV_SYS_CLK,
#endif
#if defined(CLOCK_IP_HAS_VLPR_CORE_CLK)
    VLPR_CORE_CLK                 =   CLOCK_IP_HAS_VLPR_CORE_CLK,
#endif
#if defined(CLOCK_IP_HAS_VLPR_SYS_CLK)
    VLPR_SYS_CLK                  =   CLOCK_IP_HAS_VLPR_SYS_CLK,
#endif
#if defined(CLOCK_IP_HAS_VLPR_FLASH_CLK)
    VLPR_FLASH_CLK                =   CLOCK_IP_HAS_VLPR_FLASH_CLK,
#endif
#if defined(CLOCK_IP_HAS_VLPR_BUS_CLK)
    VLPR_BUS_CLK                  =   CLOCK_IP_HAS_VLPR_BUS_CLK,
#endif
...
/** @brief Clock ip monitor maximum allowed frequency variation. */
typedef enum
{
    CLOCK_IP_MAXIMUM_5_PERCENTAGE_DEVIATION            = 500U,       /**< @brief Maximum 5% variation. */
    CLOCK_IP_MAXIMUM_4_POINT_9_PERCENTAGE_DEVIATION    = 490U,       /**< @brief Maximum 4.9% variation. */
    CLOCK_IP_MAXIMUM_4_POINT_8_PERCENTAGE_DEVIATION    = 480U,       /**< @brief Maximum 4.8% variation. */
    CLOCK_IP_MAXIMUM_4_POINT_7_PERCENTAGE_DEVIATION    = 470U,       /**< @brief Maximum 4.7% variation. */
    CLOCK_IP_MAXIMUM_4_POINT_6_PERCENTAGE_DEVIATION    = 460U,       /**< @brief Maximum 4.6% variation. */
    CLOCK_IP_MAXIMUM_4_POINT_5_PERCENTAGE_DEVIATION    = 450U,       /**< @brief Maximum 4.5% variation. */
    CLOCK_IP_MAXIMUM_4_POINT_4_PERCENTAGE_DEVIATION    = 440U,       /**< @brief Maximum 4.4% variation. */
    CLOCK_IP_MAXIMUM_4_POINT_3_PERCENTAGE_DEVIATION    = 430U,       /**< @brief Maximum 4.3% variation. */
    CLOCK_IP_MAXIMUM_4_POINT_2_PERCENTAGE_DEVIATION    = 420U,       /**< @brief Maximum 4.2% variation. */
    CLOCK_IP_MAXIMUM_4_POINT_1_PERCENTAGE_DEVIATION    = 410U,       /**< @brief Maximum 4.1% variation. */
    CLOCK_IP_MAXIMUM_4_PERCENTAGE_DEVIATION            = 400U,       /**< @brief Maximum 4.0% variation. */
    CLOCK_IP_MAXIMUM_3_POINT_9_PERCENTAGE_DEVIATION    = 390U,       /**< @brief Maximum 3.9% variation. */
    CLOCK_IP_MAXIMUM_3_POINT_8_PERCENTAGE_DEVIATION    = 380U,       /**< @brief Maximum 3.8% variation. */
    CLOCK_IP_MAXIMUM_3_POINT_7_PERCENTAGE_DEVIATION    = 370U,       /**< @brief Maximum 3.7% variation. */
    CLOCK_IP_MAXIMUM_3_POINT_6_PERCENTAGE_DEVIATION    = 360U,       /**< @brief Maximum 3.6% variation. */
    CLOCK_IP_MAXIMUM_3_POINT_5_PERCENTAGE_DEVIATION    = 350U,       /**< @brief Maximum 3.5% variation. */
    CLOCK_IP_MAXIMUM_3_POINT_4_PERCENTAGE_DEVIATION    = 340U,       /**< @brief Maximum 3.4% variation. */
    CLOCK_IP_MAXIMUM_3_POINT_3_PERCENTAGE_DEVIATION    = 330U,       /**< @brief Maximum 3.3% variation. */
    CLOCK_IP_MAXIMUM_3_POINT_2_PERCENTAGE_DEVIATION    = 320U,       /**< @brief Maximum 3.2% variation. */
    CLOCK_IP_MAXIMUM_3_POINT_1_PERCENTAGE_DEVIATION    = 310U,       /**< @brief Maximum 3.1% variation. */
    CLOCK_IP_MAXIMUM_3_PERCENTAGE_DEVIATION            = 300U,       /**< @brief Maximum 3.0% variation. */
    CLOCK_IP_MAXIMUM_2_POINT_9_PERCENTAGE_DEVIATION    = 290U,       /**< @brief Maximum 2.9% variation. */
    CLOCK_IP_MAXIMUM_2_POINT_8_PERCENTAGE_DEVIATION    = 280U,       /**< @brief Maximum 2.8% variation. */
    CLOCK_IP_MAXIMUM_2_POINT_7_PERCENTAGE_DEVIATION    = 270U,       /**< @brief Maximum 2.7% variation. */
    CLOCK_IP_MAXIMUM_2_POINT_6_PERCENTAGE_DEVIATION    = 260U,       /**< @brief Maximum 2.6% variation. */
    CLOCK_IP_MAXIMUM_2_POINT_5_PERCENTAGE_DEVIATION    = 250U,       /**< @brief Maximum 2.5% variation. */
    CLOCK_IP_MAXIMUM_2_POINT_4_PERCENTAGE_DEVIATION    = 240U,       /**< @brief Maximum 2.4% variation. */
    CLOCK_IP_MAXIMUM_2_POINT_3_PERCENTAGE_DEVIATION    = 230U,       /**< @brief Maximum 2.3% variation. */
    CLOCK_IP_MAXIMUM_2_POINT_2_PERCENTAGE_DEVIATION    = 220U,       /**< @brief Maximum 2.2% variation. */
    CLOCK_IP_MAXIMUM_2_POINT_1_PERCENTAGE_DEVIATION    = 210U,       /**< @brief Maximum 2.1% variation. */
    CLOCK_IP_MAXIMUM_2_PERCENTAGE_DEVIATION            = 200U,       /**< @brief Maximum 2.0% variation. */
    CLOCK_IP_MAXIMUM_1_POINT_9_PERCENTAGE_DEVIATION    = 190U,       /**< @brief Maximum 1.9% variation. */
    CLOCK_IP_MAXIMUM_1_POINT_8_PERCENTAGE_DEVIATION    = 180U,       /**< @brief Maximum 1.8% variation. */
    CLOCK_IP_MAXIMUM_1_POINT_7_PERCENTAGE_DEVIATION    = 170U,       /**< @brief Maximum 1.7% variation. */
    CLOCK_IP_MAXIMUM_1_POINT_6_PERCENTAGE_DEVIATION    = 160U,       /**< @brief Maximum 1.6% variation. */
    CLOCK_IP_MAXIMUM_1_POINT_5_PERCENTAGE_DEVIATION    = 150U,       /**< @brief Maximum 1.5% variation. */
    CLOCK_IP_MAXIMUM_1_POINT_4_PERCENTAGE_DEVIATION    = 140U,       /**< @brief Maximum 1.4% variation. */
    CLOCK_IP_MAXIMUM_1_POINT_3_PERCENTAGE_DEVIATION    = 130U,       /**< @brief Maximum 1.3% variation. */
    CLOCK_IP_MAXIMUM_1_POINT_2_PERCENTAGE_DEVIATION    = 120U,       /**< @brief Maximum 1.2% variation. */
    CLOCK_IP_MAXIMUM_1_POINT_1_PERCENTAGE_DEVIATION    = 110U,       /**< @brief Maximum 1.1% variation. */
    CLOCK_IP_MAXIMUM_1_PERCENTAGE_DEVIATION            = 100U,       /**< @brief Maximum 1.0% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_9_PERCENTAGE_DEVIATION    = 90U,        /**< @brief Maximum 0.9% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_8_PERCENTAGE_DEVIATION    = 80U,        /**< @brief Maximum 0.8% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_7_PERCENTAGE_DEVIATION    = 70U,        /**< @brief Maximum 0.7% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_6_PERCENTAGE_DEVIATION    = 60U,        /**< @brief Maximum 0.6% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_5_PERCENTAGE_DEVIATION    = 50U,        /**< @brief Maximum 0.5% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_4_PERCENTAGE_DEVIATION    = 40U,        /**< @brief Maximum 0.4% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_3_PERCENTAGE_DEVIATION    = 30U,        /**< @brief Maximum 0.3% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_2_PERCENTAGE_DEVIATION    = 20U,        /**< @brief Maximum 0.2% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_1_PERCENTAGE_DEVIATION    = 10U,        /**< @brief Maximum 0.1% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_09_PERCENTAGE_DEVIATION   = 9U,         /**< @brief Maximum 0.09% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_08_PERCENTAGE_DEVIATION   = 8U,         /**< @brief Maximum 0.08% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_07_PERCENTAGE_DEVIATION   = 7U,         /**< @brief Maximum 0.07% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_06_PERCENTAGE_DEVIATION   = 6U,         /**< @brief Maximum 0.06% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_05_PERCENTAGE_DEVIATION   = 5U,         /**< @brief Maximum 0.05% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_04_PERCENTAGE_DEVIATION   = 4U,         /**< @brief Maximum 0.04% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_03_PERCENTAGE_DEVIATION   = 3U,         /**< @brief Maximum 0.03% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_02_PERCENTAGE_DEVIATION   = 2U,         /**< @brief Maximum 0.02% variation. */
    CLOCK_IP_MAXIMUM_0_POINT_01_PERCENTAGE_DEVIATION   = 1U,         /**< @brief Maximum 0.01% variation. */
...
typedef enum
{
    CLOCK_IP_LOWEST_LATENCY                 = 0U,         /**< @brief Clock monitor is configured to react as fast as possible. A clock failure is detected by clock monitor unit in less than one microsecond. */
    CLOCK_IP_LOW_LATENCY_1US                = 1U,         /**< @brief Clock monitor reaction is taking 1us. A clock failure is detected by clock monitor unit in one microsecond. */
    CLOCK_IP_MEDIUM_LATENCY_10US            = 10U,        /**< @brief Clock monitor reaction is taking 10us. A clock failure is detected by clock monitor unit in 10 microseconds. */
    CLOCK_IP_HIGH_LATENCY_100US             = 100U,       /**< @brief Clock monitor reaction is taking 100us. A clock failure is detected by clock monitor unit in 100 microseconds. */
    CLOCK_IP_VERY_HIGH_LATENCY_1MS          = 1000U,       /**< @brief Clock monitor reaction is taking 1ms. A clock failure is detected by clock monitor unit in 1 milisecond. */

} Clock_Ip_MonitorLatencyType;
/*==================================================================================================
...
typedef struct
{
    ...
    Clock_Ip_MonitorFrequencyVariationType Variation;                      /**< Maximum allowed frequency variation. */
    Clock_Ip_MonitorLatencyType            Latency;                        /**< Monitor latency range. */
...
typedef struct
{
    ...
    uint8 ClockPartitionId;                                                          /**< @brief The ID for Partition. */
#endif
#endif
