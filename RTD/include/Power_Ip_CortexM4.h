...
#define POWER_IP_CORTEXM4_SW_MAJOR_VERSION             3
...
/***********************************************************/
#define POWER_IP_CM4_AIRCR_BASEADDR                   ((uint32)0xE000ED0CU)

#define POWER_IP_CM4_AIRCR_SYSRESETREQ_MASK           0x4u

#define POWER_IP_CM4_AIRCR_PRIGROUP_MASK              0x700u

#define POWER_IP_POWER_IP_CM4_AIRCR_VECTKEY_MASK               0xFFFF0000u
#define POWER_IP_POWER_IP_CM4_AIRCR_VECTKEY_SHIFT              16u
#define POWER_IP_CM4_AIRCR_VECTKEY(x)                 (((uint32)(((uint32)(x))<<POWER_IP_POWER_IP_CM4_AIRCR_VECTKEY_SHIFT))&POWER_IP_POWER_IP_CM4_AIRCR_VECTKEY_MASK)

#define POWER_IP_CM4_SCR_SLEEPONEXIT_MASK32           ((uint32)0x00000002U)
#define POWER_IP_CM4_SCR_SLEEPDEEP_MASK32             ((uint32)0x00000004U)
