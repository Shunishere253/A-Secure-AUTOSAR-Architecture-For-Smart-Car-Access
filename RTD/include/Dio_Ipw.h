...
#if (DIO_IPW_VENDOR_ID_H != GPIO_DIO_IP_VENDOR_ID_H)
...
#if ((DIO_IPW_AR_RELEASE_MAJOR_VERSION_H    != GPIO_DIO_IP_AR_RELEASE_MAJOR_VERSION_H) || \
     (DIO_IPW_AR_RELEASE_MINOR_VERSION_H    != GPIO_DIO_IP_AR_RELEASE_MINOR_VERSION_H) || \
     (DIO_IPW_AR_RELEASE_REVISION_VERSION_H != GPIO_DIO_IP_AR_RELEASE_REVISION_VERSION_H) \
    )
...
#if ((DIO_IPW_SW_MAJOR_VERSION_H != GPIO_DIO_IP_SW_MAJOR_VERSION_H) || \
     (DIO_IPW_SW_MINOR_VERSION_H != GPIO_DIO_IP_SW_MINOR_VERSION_H) || \
     (DIO_IPW_SW_PATCH_VERSION_H != GPIO_DIO_IP_SW_PATCH_VERSION_H)    \
    )
...
#define DIO_IPW_CHECK_CHANNEL_VALIDITY(ChannelId)   (DIO_BIT1_LEFTMOST_MASK_U32<<((ChannelId) & GPIO_DIO_IP_CHANNEL_MASK_U32))
#endif

#define DIO_IPW_PORTID_SHIFT_U8                     ((uint8)5U)
