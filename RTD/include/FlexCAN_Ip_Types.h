...
#if ((FLEXCAN_IP_TYPES_AR_RELEASE_MAJOR_VERSION_H    != STD_AR_RELEASE_MAJOR_VERSION) || \
     (FLEXCAN_IP_TYPES_AR_RELEASE_MINOR_VERSION_H    != STD_AR_RELEASE_MINOR_VERSION) \
    )
    #error "AutoSar Version Numbers of FlexCAN_Ip_Types.h and Std_Types.h are different"
#endif
#endif
/*==================================================================================================
*                                          CONSTANTS
...
/**@brief Lowest Buffer Transmitted First */
#define FLEXCAN_IP_LOWEST_BUFF_FIRST_U32           ((uint32)0x00000080U)
/*==================================================================================================
*                                             ENUMS
====================================================================================================*/
...
/* implements  Flexcan_Ip_EnhancedFilterType_enum */
typedef enum
{
