 ...
 *
 */
extern uint32 hwAcc_Init_Uint(TRGMUX_Type * const pTrgmux, uint8 TrgmuxCount);
 ...
 * @param[in]    pxTrgmuxInit     Pointer to the initialization structure.
 * @param[in]    Output           Specifies the Output
 * @return       The lock status of output.
 *
 */
extern uint32 hwAcc_GetLockForOutput_Uint(const TRGMUX_Type * const pTrgmux, const uint32 Output);
