...
/* Check if current file and FlexCAN_Ip_Wrapper header file are of the same Software version */
    ...
    #if ((FLEXCAN_IP_AR_RELEASE_MAJOR_VERSION_H   != OSIF_AR_RELEASE_MAJOR_VERSION) || \
         (FLEXCAN_IP_AR_RELEASE_MINOR_VERSION_H   != OSIF_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of FlexCAN_Ip.h and OsIf.h are different"
    #endif
#endif
