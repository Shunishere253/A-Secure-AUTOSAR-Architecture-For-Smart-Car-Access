...
#define PORT_CI_PORT_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION_H                3
...
==================================================================================================*/
    ...
    /* Check if Port_Ci_Port_Ip_TrustedFunctions.h and Std_Types.h are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Port_Ci_Port_Ip_TrustedFunctions.h and Std_Types.h are different"
    #endif
#endif
