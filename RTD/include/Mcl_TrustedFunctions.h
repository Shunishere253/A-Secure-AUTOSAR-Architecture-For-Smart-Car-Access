...
#include "Ftm_Ip_TrustedFunctions.h"
...
/* Check if MCL_TrustedFunctions.h file and Ftm_Ip_TrustedFunctions.h file are of the same vendor */
#if (MCL_TRUSTEDFUNCTIONS_VENDOR_ID != FTM_IP_TRUSTEDFUNCTIONS_VENDOR_ID)
    #error "Mcl_TrustedFunctions.h and Ftm_Ip_TrustedFunctions.h have different vendor ids"
#endif

/* Check if MCL_TrustedFunctions.h file and Ftm_Ip_TrustedFunctions.h file are of the same Autosar version */
#if ((MCL_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION != FTM_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION) || \
     (MCL_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION != FTM_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION) || \
     (MCL_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION != FTM_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of MCL_TrustedFunctions.h and Ftm_Ip_TrustedFunctions.h are different"
#endif

/* Check if MCL_TrustedFunctions.h file and Ftm_Ip_TrustedFunctions.h file are of the same Software version */
#if ((MCL_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION != FTM_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION) || \
     (MCL_TRUSTEDFUNCTIONS_SW_MINOR_VERSION != FTM_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION) || \
     (MCL_TRUSTEDFUNCTIONS_SW_PATCH_VERSION != FTM_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of MCL_TrustedFunctions.h and Ftm_Ip_TrustedFunctions.h are different"
#endif
/*==================================================================================================
                                           CONSTANTS
==================================================================================================*/
