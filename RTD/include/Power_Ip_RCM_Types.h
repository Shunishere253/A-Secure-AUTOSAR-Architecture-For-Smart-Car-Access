...
#define POWER_IP_RCM_TYPES_SW_MAJOR_VERSION                3
...
/* Check if source file and Std_Types.h file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Power_Ip_RCM_Types.h  and Std_Types.h are different"
#endif
#endif
...
#if (defined(POWER_IP_DERIVATIVE_009) || defined(POWER_IP_DERIVATIVE_010) || defined(POWER_IP_DERIVATIVE_011) || defined(POWER_IP_DERIVATIVE_012))
    #define RCM_SSRS_INTERRUPT_FLAGS_MASK32     ((uint32)0x00002FECU)
#else
    #define RCM_SSRS_INTERRUPT_FLAGS_MASK32     ((uint32)0x00002FFCU)
#endif
