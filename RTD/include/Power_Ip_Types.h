...
#define POWER_IP_TYPES_SW_MAJOR_VERSION                3
...
#define POWER_IP_E_ISR_LOW_VOLTAGE_DETECT_ERROR      ((uint8)0x07U)
#define POWER_IP_E_ISR_LOW_VOLTAGE_WARNING_ERROR     ((uint8)0x08U)
  #endif
#endif
