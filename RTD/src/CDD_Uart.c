...
static void Uart_InitChannelProcess(uint8 PartitionId);
...
/**
* @internal
* @brief   Process for initializes the UART module.
...
void Uart_Init(const Uart_ConfigType * Config)
{
    ...
    else
    {
        ...
        else
        {
            ...
            /* Process for init channel */
            Uart_InitChannelProcess(PartitionId);
        }
    }
}
...
void Uart_Deinit(void)
{
    ...
    /* Check whether the UART driver is in UART_UNINIT state */
