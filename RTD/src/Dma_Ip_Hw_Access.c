...
#if (DMA_IP_HW_ACCESS_VENDOR_ID_C != DMA_IP_HWV2_ACCESSINLINE_VENDOR_ID)
...
#if ((DMA_IP_HW_ACCESS_AR_RELEASE_MAJOR_VERSION_C != DMA_IP_HWV2_ACCESSINLINE_AR_RELEASE_MAJOR_VERSION) || \
     (DMA_IP_HW_ACCESS_AR_RELEASE_MINOR_VERSION_C != DMA_IP_HWV2_ACCESSINLINE_AR_RELEASE_MINOR_VERSION) || \
     (DMA_IP_HW_ACCESS_AR_RELEASE_REVISION_VERSION_C != DMA_IP_HWV2_ACCESSINLINE_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((DMA_IP_HW_ACCESS_SW_MAJOR_VERSION_C != DMA_IP_HWV2_ACCESSINLINE_SW_MAJOR_VERSION) || \
     (DMA_IP_HW_ACCESS_SW_MINOR_VERSION_C != DMA_IP_HWV2_ACCESSINLINE_SW_MINOR_VERSION) || \
     (DMA_IP_HW_ACCESS_SW_PATCH_VERSION_C != DMA_IP_HWV2_ACCESSINLINE_SW_PATCH_VERSION) \
    )
...
#define DMA_IP_AE_START_ADDRESS            ((uint32)0x0U)
...
==================================================================================================*/
#if (STD_ON == DMA_IP_HWV2_IS_AVAILABLE)
    Dma_Ip_Hwv2InstRegType       * const g_ptHwv2BaseInstPtrArray[DMA_IP_HWV2_DMA_NOF_INST] = DMA_IP_DMA_HWV2_BASE_PTRS;
    Dma_Ip_Hwv2TcdArrayType      * const g_ptHwv2BaseTcdPtrArray[DMA_IP_HWV2_TCD_NOF_INST] = DMA_IP_TCD_HWV2_BASE_PTRS;
#endif /* #if (STD_ON == DMA_IP_HWV2_IS_AVAILABLE) */
...
#endif
#if ((DMA_IP_STORE_DST_ADDR_IS_AVAILABLE == STD_OFF) || (DMA_IP_END_OF_PACKET_SIGNAL_IS_AVAILABLE == STD_OFF) || (DMA_IP_TRANSFER_MODE_CONTROL_IS_AVAILABLE == STD_OFF))
static void HwAccDmaCh_SetTransferDummyFunction(const uint32 LocHwVers, Dma_Ip_TcdRegType * pxLocTcd, const uint32 LocValue);
#endif
#if (DMA_IP_BANDWIDTH_CONTROL_IS_AVAILABLE == STD_OFF)
static void HwAccDmaCh_BandwithControlrDummyFunction(const uint32 LocHwVers, Dma_Ip_TcdRegType * pxLocTcd, const uint32 LocValue);
#endif
...
static void HwAccDmaCh_CmdClearInterruptStatus(const uint32 LocHwVers, const uint32 LocHwInst, const uint32 LocHwCh);
...
static void HwAccDmaCh_SetSwapSize(const uint32 LocHwVers, const uint32 LocHwInst, const uint32 LocHwCh, const uint32 LocValue);
#endif
...
#endif
#if (STD_ON == DMA_IP_BANDWIDTH_CONTROL_IS_AVAILABLE)
...
static void HwAccDmaCh_SetControl_TransferModeControl(const uint32 LocHwVers, Dma_Ip_TcdRegType * pxLocTcd, const uint32 LocValue);
...
static void HwAccDmaCh_SetTransferDummyFunction(const uint32 LocHwVers, Dma_Ip_TcdRegType * pxLocTcd, const uint32 LocValue)
{
    ...
    (void)LocValue;
    DMA_IP_DEV_ASSERT(FALSE);
    /*The bellow code line (pxLocTcd->reg_CSR = (uint16)0U;)is only to avoid Misra rule 8.13. It will be not implemented in runtime of program
     *because a failure assert will be raised by above code line (DMA_IP_DEV_ASSERT(FALSE);)*/
    pxLocTcd->reg_CSR = (uint16)0U;
}
#endif
...
static void HwAccDmaCh_GetParamDummyFunction(const uint32 LocHwVers, const uint32 LocHwInst, const uint32 LocHwCh, uint32 * const retValue)
{
    ...
    (void)LocHwCh;
    DMA_IP_DEV_ASSERT(FALSE);
    /*The bellow code line (*retValue = 0U;)is only to avoid Misra rule 8.13. It will be not implemented in runtime of program
     *because a failure assert will be raised by above code line (DMA_IP_DEV_ASSERT(FALSE);)*/
    *retValue = 0U;
}
#endif
...
#if (STD_ON == DMA_IP_HWV2_IS_AVAILABLE)
        case DMA_IP_HARDWARE_VERSION_2:
            MCAL_FAULT_INJECTION_POINT(MCL_GET_INSTANCE_ERROR_FAULT_INJECTION);
            ...
            hwv2AccInlineDmaInst_GetEdmaVersion(g_ptHwv2BaseInstPtrArray[LocHwInst], &Status->Version);
        break;
#endif /* #if (STD_ON == DMA_IP_HWV2_IS_AVAILABLE) */
...
#if (STD_ON == DMA_IP_HWV2_IS_AVAILABLE)
        case DMA_IP_HARDWARE_VERSION_2:
            hwv2AccInlineDmaCh_CmdClearInterruptStatus(DMA_IP_HWV2_TCD_CH_VALUE(LocHwInst), LocHwCh);
        break;
#endif /* #if (STD_ON == DMA_IP_HWV2_IS_AVAILABLE) */
...
void HwAccDmaCh_SetCommand(const uint32 Command, const uint32 LocHwVers, const uint32 LocHwInst, const uint32 LocHwCh)
{
    static void (* const fpHwAcc_DmaCh_Command[])(const uint32 LocHwVers, const uint32 LocHwInst, const uint32 LocHwCh) =
    {
        ...
        &HwAccDmaCh_CmdClearInterruptStatus,
    };
...
void HwAccDmaCh_GetStatus_Error(const uint32 LocHwVers, const uint32 LocHwInst, const uint32 LocHwCh, uint32 * const pLocError)
{
    switch (LocHwVers)
    {
        ...
        case DMA_IP_HARDWARE_VERSION_2:
            (void)LocHwCh;
            MCAL_FAULT_INJECTION_POINT(MCL_GET_CHANNEL_ERROR_FAULT_INJECTION);
...
#else
        &HwAccDmaCh_BandwithControlrDummyFunction,
#endif
#if (STD_ON == DMA_IP_TRANSFER_MODE_CONTROL_IS_AVAILABLE)
...
void HwAccDmaCh_LoadConfigIntoSoftwareTcd(uint32 HwVersId, const Dma_Ip_ScatterGatherConfigType * const pxLocScatterGather, const uint32 ElementId, const boolean NotLastElement)
{
#if (STD_ON == DMA_IP_HWV2_IS_AVAILABLE)
    uint32 hwLinkCh;
#endif /* STD_ON == DMA_IP_HWV2_IS_AVAILABLE */
    ...
    if (DMA_IP_HARDWARE_VERSION_2 == HwVersId)
    {
        ...
        {
            hwv2AccInlineDmaCh_SetControl_ScatterGatherAddress(pxLocScatterGather->Stcd, (uint32)pxLocScatterGather->NextConfig->Stcd - DMA_IP_AE_START_ADDRESS);
        }
        else
        {
        ...
        if (NULL_PTR != pxLocScatterGather->TransferConfig)
        {
            ...
            /* Source */
            hwv2AccInlineDmaCh_SetSource_Params(pxLocScatterGather->Stcd, pxLocScatterGather->TransferConfig->Source.Addr,(uint32)pxLocScatterGather->TransferConfig->Source.SignedOffset, (uint32)pxLocScatterGather->TransferConfig->Source.LastAddrAdj);
            /* Destination */
            hwv2AccInlineDmaCh_SetDestination_Params(pxLocScatterGather->Stcd, pxLocScatterGather->TransferConfig->Destination.Addr, (uint32)pxLocScatterGather->TransferConfig->Destination.SignedOffset);
            /* Transfer Attributes */
            ...
            hwv2AccInlineDmaCh_SetMinorLoop_Params(pxLocScatterGather->Stcd, pxLocScatterGather->TransferConfig->MinorLoop.EnLink ? 1U : 0U, hwLinkCh, pxLocScatterGather->TransferConfig->MinorLoop.Size);
            /* MajorLoop */
            if (TRUE == pxLocScatterGather->TransferConfig->MajorLoop.EnLink)
            {
                ...
                hwv2AccInlineDmaCh_SetMajorLoop_Params(pxLocScatterGather->Stcd, pxLocScatterGather->TransferConfig->MajorLoop.EnLink ? 1U : 0U, hwLinkCh, pxLocScatterGather->TransferConfig->MajorLoop.Count);
            }
            else
            {
                hwv2AccInlineDmaCh_SetMajorLoop_Params(pxLocScatterGather->Stcd, pxLocScatterGather->TransferConfig->MajorLoop.EnLink ? 1U : 0U, ElementId, pxLocScatterGather->TransferConfig->MajorLoop.Count);
            }
        }
    }
    else
...
void HwAccDmaCh_LoadSoftwareTcdIntoHardwareTcd(const Dma_Ip_LogicChannelIdType * const pxLocLogicCh, const Dma_Ip_ScatterGatherConfigType * const pxLocScatterGather)
{
    ...
    if (DMA_IP_HARDWARE_VERSION_2 == LocHwVers)
    {
        ...
        DMA_IP_HWV2_TCD_TCD_VALUE(LocHwInst, LocHwCh).reg_SLAST_SDA = pxLocScatterGather->Stcd->reg_SLAST_SDA;
