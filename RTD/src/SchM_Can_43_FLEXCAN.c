...
* 
*/
uint32 Can_43_FLEXCan_43_FLEXCAN_schm_read_msr(void); 
...
#ifdef MCAL_PLATFORM_ARM
#if (MCAL_PLATFORM_ARM == MCAL_ARM_AARCH64)
ASM_KEYWORD uint32 Can_43_FLEXCan_43_FLEXCAN_schm_read_msr(void)
{
    mrs x0, S3_3_c4_c2_1
}
#elif  (MCAL_PLATFORM_ARM == MCAL_ARM_RARCH)
...
#ifdef MCAL_PLATFORM_S12
    #define Can_43_FLEXCan_43_FLEXCAN_schm_read_msr()  ASM_KEYWORD("tfr ccr, d6")
#else
    #define Can_43_FLEXCan_43_FLEXCAN_schm_read_msr() ASM_KEYWORD("mfmsr r3")
#endif
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_00(void)
{
    ...
    if(0UL == reentry_guard_CAN_EXCLUSIVE_AREA_00[u32CoreId])
    {
        ...
        msr = OsIf_Trusted_Call_Return(Can_43_FLEXCan_43_FLEXCAN_schm_read_msr);
#else
        msr = Can_43_FLEXCan_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
