...
#define CLOCK_IP_DATA_SW_MAJOR_VERSION_C               3
...
#elif (defined (CLOCK_IP_DERIVATIVE_004) || defined(CLOCK_IP_DERIVATIVE_006) || defined(CLOCK_IP_DERIVATIVE_012) || \
    defined(CLOCK_IP_DERIVATIVE_010) || defined(CLOCK_IP_DERIVATIVE_011) || defined(CLOCK_IP_DERIVATIVE_009) || defined(CLOCK_IP_DERIVATIVE_013) || defined(CLOCK_IP_DERIVATIVE_015))
...
/* CLOCK_IP_CMU FIRC_MON1_CLK */
{
    ...
    CLOCK_IP_MAXIMUM_3_POINT_3_PERCENTAGE_DEVIATION, /* Maximum allowed variation of reference clock: 3.3% for SIRC_CLK */
