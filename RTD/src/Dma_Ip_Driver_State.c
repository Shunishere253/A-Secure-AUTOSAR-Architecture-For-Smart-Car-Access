...
static void Dma_Ip_SetHwChannel_ResetEvent(const uint32 LocHwVers,
                                           const uint32 LocHwInst,
                                           const uint32 LocHwCh
                                          );

static void Dma_Ip_SetHwChannel_ReadyEvent(const uint32 LocHwVers,
                                           const uint32 LocHwInst,
                                           const uint32 LocHwCh
                                          );

static void Dma_Ip_SetHwChannel_TransferEvent(const uint32 LocHwVers,
                                              const uint32 LocHwInst,
                                              const uint32 LocHwCh
                                             );

static void Dma_Ip_SetHwChannel_ScatterGatherEvent(const uint32 LocHwVers,
                                                   const uint32 LocHwInst,
                                                   const uint32 LocHwCh
                                                  );

static void Dma_Ip_SetHwChannel_ErrorEvent(const uint32 LocHwVers,
                                           const uint32 LocHwInst,
                                           const uint32 LocHwCh
                                          );
...
void Dma_Ip_SetHwChannelState(const uint32 LocHwVers,
                              const uint32 LocHwInst,
                              const uint32 LocHwCh,
                              const Dma_Ip_HwChannelEventValueEnum EventValue
                             )
{
...
*                                        GLOBAL FUNCTIONS
==================================================================================================*/
Dma_Ip_HwChannelStateValueType Dma_Ip_GetHwChannelState(uint32 LocHwVers,
                                                        uint32 LocHwInst,
                                                        uint32 LocHwCh
                                                       )
{
...
Dma_Ip_HwChannelStateType * Dma_Ip_GetHwChannelStatePointer(uint32 LocHwVers,
                                                            uint32 LocHwInst,
                                                            uint32 LocHwCh
                                                           )
{
...
void Dma_Ip_SetHwChannelStatePointer(uint32 LocHwVers,
                                     uint32 LocHwInst,
                                     uint32 LocHwCh,
                                     Dma_Ip_HwChannelStateType * StatePointer
                                    )
{
#if (STD_ON == DMA_IP_HWV2_IS_AVAILABLE)
    if (DMA_IP_HARDWARE_VERSION_2 == LocHwVers)
