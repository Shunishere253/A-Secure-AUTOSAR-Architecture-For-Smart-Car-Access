...
#if (defined(S32K118) || defined(S32K116) || defined(S32K116V) || defined(S32K118V))
...
#endif /* (defined(S32K118) || defined(S32K116) || defined(S32K116V) || defined(S32K118V)) */
...
#if (FLEXCAN_IP_FEATURE_HAS_PRETENDED_NETWORKING == STD_ON)
/* Implementation of CAN0 handler named in startup code for processing of Pretended Networking Wakeup. */
ISR(CAN0_Wake_Up_IRQHandler)
{
