...
#define POWER_IP_RCM_SW_MAJOR_VERSION_C               3
...
void Power_Ip_RCM_ResetInit(const Power_Ip_RCM_ConfigType * ConfigPtr)
{
    ...
    if ((uint32)0x00U != (uint32)(ConfigPtr->ResetInterruptEnableConfig & RCM_SRIE_RWBITS_MASK32))
    {
        Power_Ip_u32ResetStatus = (uint32)(IP_RCM->SSRS & RCM_SSRS_RWBITS_MASK32);
        /* Clear all status flags*/
        IP_RCM->SSRS = RCM_SSRS_INTERRUPT_FLAGS_MASK32;
    }
