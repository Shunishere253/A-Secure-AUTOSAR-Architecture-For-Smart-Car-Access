...
#define CLOCK_IP_SCS_SELECTOR_HARDWARE_VALUES_NO              8U
#define CLOCK_IP_PCS1_SELECTOR_HARDWARE_VALUES_NO             8U
...
static uint64 get_Zero_Frequency(void);
static uint64 get_LPO_128K_CLK_Frequency(void);
static uint64 get_FIRC_CLK_Frequency(void);
static uint64 get_SOSC_CLK_Frequency(void);
static uint64 get_SIRC_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_SPLL_CLK)
static uint64 get_SPLL_CLK_Frequency(void);
#endif
static uint64 get_SIRCDIV1_CLK_Frequency(void);
static uint64 get_SIRCDIV2_CLK_Frequency(void);
static uint64 get_FIRCDIV1_CLK_Frequency(void);
static uint64 get_FIRCDIV2_CLK_Frequency(void);
static uint64 get_SOSCDIV1_CLK_Frequency(void);
static uint64 get_SOSCDIV2_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_SPLLDIV1_CLK)
static uint64 get_SPLLDIV1_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_SPLLDIV2_CLK)
static uint64 get_SPLLDIV2_CLK_Frequency(void);
#endif
static uint64 get_LPO_32K_CLK_Frequency(void);
static uint64 get_LPO_1K_CLK_Frequency(void);
static uint64 get_tclk0_ref_Frequency(void);
static uint64 get_tclk1_ref_Frequency(void);
static uint64 get_tclk2_ref_Frequency(void);
static uint64 get_rtc_clkin_Frequency(void);
static uint64 get_SCS_CLK_Frequency(void);
static uint64 get_CORE_CLK_Frequency(void);
static uint64 get_BUS_CLK_Frequency(void);
static uint64 get_SLOW_CLK_Frequency(void);

#if defined(CLOCK_IP_HAS_SCS_HSRUN_CLK)
static uint64 get_SCS_HSRUN_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_CORE_HSRUN_CLK)
static uint64 get_CORE_HSRUN_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_BUS_HSRUN_CLK)
static uint64 get_BUS_HSRUN_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_SLOW_HSRUN_CLK)
static uint64 get_SLOW_HSRUN_CLK_Frequency(void);
#endif
static uint64 get_SCS_RUN_CLK_Frequency(void);
static uint64 get_CORE_RUN_CLK_Frequency(void);
static uint64 get_BUS_RUN_CLK_Frequency(void);
static uint64 get_SLOW_RUN_CLK_Frequency(void);
static uint64 get_SCS_VLPR_CLK_Frequency(void);
static uint64 get_CORE_VLPR_CLK_Frequency(void);
static uint64 get_BUS_VLPR_CLK_Frequency(void);
static uint64 get_SLOW_VLPR_CLK_Frequency(void);

static uint64 get_RTC_CLK_Frequency(void);
static uint64 get_LPO_CLK_Frequency(void);
static uint64 get_SCG_CLKOUT_CLK_Frequency(void);
static uint64 get_FTM0_EXT_CLK_Frequency(void);
static uint64 get_FTM1_EXT_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_FTM2_EXT_CLK)
static uint64 get_FTM2_EXT_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_FTM3_EXT_CLK)
static uint64 get_FTM3_EXT_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_FTM4_EXT_CLK)
static uint64 get_FTM4_EXT_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_FTM5_EXT_CLK)
static uint64 get_FTM5_EXT_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_FTM6_EXT_CLK)
static uint64 get_FTM6_EXT_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_FTM7_EXT_CLK)
static uint64 get_FTM7_EXT_CLK_Frequency(void);
#endif
static uint64 get_ADC0_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_ADC1_CLK)
static uint64 get_ADC1_CLK_Frequency(void);
#endif
static uint64 get_CLKOUT0_CLK_Frequency(void);
static uint64 get_CMP0_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_CMU0_CLK)
static uint64 get_CMU0_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_CMU1_CLK)
static uint64 get_CMU1_CLK_Frequency(void);
#endif
static uint64 get_CRC0_CLK_Frequency(void);
static uint64 get_DMA0_CLK_Frequency(void);
static uint64 get_DMAMUX0_CLK_Frequency(void);
static uint64 get_EIM0_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_ENET_CLK)
static uint64 get_ENET_CLK_Frequency(void);
#endif
static uint64 get_ERM0_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_EWM0_CLK)
static uint64 get_EWM0_CLK_Frequency(void);
#endif
static uint64 get_FLEXCAN0_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_FLEXCAN1_CLK)
static uint64 get_FLEXCAN1_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN2_CLK)
static uint64 get_FLEXCAN2_CLK_Frequency(void);
#endif
static uint64 get_FTM0_CLK_Frequency(void);
static uint64 get_FTM1_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_FTM2_CLK)
static uint64 get_FTM2_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_FTM3_CLK)
static uint64 get_FTM3_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_FTM4_CLK)
static uint64 get_FTM4_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_FTM5_CLK)
static uint64 get_FTM5_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_FTM6_CLK)
static uint64 get_FTM6_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_FTM7_CLK)
static uint64 get_FTM7_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_GPIO0_CLK)
static uint64 get_GPIO0_CLK_Frequency(void);
#endif
static uint64 get_FlexIO_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_FTFC_CLK)
static uint64 get_FTFC_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_FTFM_CLK)
static uint64 get_FTFM_CLK_Frequency(void);
#endif
static uint64 get_LPI2C0_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_LPI2C1_CLK)
static uint64 get_LPI2C1_CLK_Frequency(void);
#endif
static uint64 get_LPIT0_CLK_Frequency(void);
static uint64 get_LPSPI0_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_LPSPI1_CLK)
static uint64 get_LPSPI1_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_LPSPI2_CLK)
static uint64 get_LPSPI2_CLK_Frequency(void);
#endif
static uint64 get_LPTMR0_CLK_Frequency(void);
static uint64 get_LPUART0_CLK_Frequency(void);
static uint64 get_LPUART1_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_LPUART2_CLK)
static uint64 get_LPUART2_CLK_Frequency(void);
#endif
static uint64 get_MPU0_CLK_Frequency(void);
static uint64 get_MSCM0_CLK_Frequency(void);
static uint64 get_PDB0_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_PDB1_CLK)
static uint64 get_PDB1_CLK_Frequency(void);
#endif
static uint64 get_PORTA_CLK_Frequency(void);
static uint64 get_PORTB_CLK_Frequency(void);
static uint64 get_PORTC_CLK_Frequency(void);
static uint64 get_PORTD_CLK_Frequency(void);
static uint64 get_PORTE_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_QSPI_CLK)
static uint64 get_QSPI_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_QSPI_SFIF_CLK_HYP_PREMUX_CLK)
static uint64 get_QSPI_SFIF_CLK_HYP_PREMUX_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_QSPI_SFIF_CLK)
static uint64 get_QSPI_SFIF_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_QSPI_2xSFIF_CLK)
static uint64 get_QSPI_2xSFIF_CLK_Frequency(void);
#endif
static uint64 get_RTC0_CLK_Frequency(void);
#if defined(CLOCK_IP_HAS_SAI0_CLK)
static uint64 get_SAI0_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_SAI1_CLK)
static uint64 get_SAI1_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_TRACE_CLK)
static uint64 get_TRACE_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_SPLL_CLK)
static uint64 PLL_VCO(SCG_Type const *Base);
#endif
...
static const uint64 Clock_Ip_u32EnableClock[2U] = {CLOCK_IP_DISABLED,CLOCK_IP_ENABLED};
...
static const getFreqType FreqTable[CLOCK_IP_NAMES_NO] =
{
    ...
    &get_SIRC_CLK_Frequency,               /* SIRC_VLP_CLK */
    ...
    &get_SCS_RUN_CLK_Frequency,            /* SCS_RUN_CLK */
    &get_SCS_VLPR_CLK_Frequency,           /* SCS_VLPR_CLK */
#if defined(CLOCK_IP_HAS_SCS_HSRUN_CLK)
    &get_SCS_HSRUN_CLK_Frequency,          /* SCS_HSRUN_CLK */
#endif
    &get_CORE_CLK_Frequency,               /* CORE_CLK */
    &get_CORE_RUN_CLK_Frequency,           /* CORE_RUN_CLK */
    &get_CORE_VLPR_CLK_Frequency,          /* CORE_VLPR_CLK */
#if defined(CLOCK_IP_HAS_CORE_HSRUN_CLK)
    &get_CORE_HSRUN_CLK_Frequency,         /* CORE_HSRUN_CLK */
#endif
    &get_BUS_CLK_Frequency,                /* BUS_CLK */
    &get_BUS_RUN_CLK_Frequency,            /* BUS_RUN_CLK */
    &get_BUS_VLPR_CLK_Frequency,           /* BUS_VLPR_CLK */
#if defined(CLOCK_IP_HAS_BUS_HSRUN_CLK)
    &get_BUS_HSRUN_CLK_Frequency,          /* BUS_HSRUN_CLK */
#endif
    &get_SLOW_CLK_Frequency,               /* SLOW_CLK */
    &get_SLOW_RUN_CLK_Frequency,           /* SLOW_RUN_CLK */
    &get_SLOW_VLPR_CLK_Frequency,          /* SLOW_VLPR_CLK */
#if defined(CLOCK_IP_HAS_SLOW_HSRUN_CLK)
    &get_SLOW_HSRUN_CLK_Frequency,         /* SLOW_HSRUN_CLK */
#endif
...
#if defined(CLOCK_IP_HAS_SPLL_CLK)
static uint64 SpllFreq = CLOCK_IP_SPLL_FREQ;
...
static uint64 Clock_Ip_u32Sosc = CLOCK_IP_DEFAULT_SOSC_FREQUENCY;
...
static uint64 get_FIRC_CLK_Frequency(void) {
    ...
    return (uint64)CLOCK_IP_FIRC_FREQUENCY & Clock_Ip_u32EnableClock[((IP_SCG->FIRCCSR & SCG_FIRCCSR_FIRCEN_MASK) >> SCG_FIRCCSR_FIRCEN_SHIFT)];
}
...
static uint64 get_SIRC_CLK_Frequency(void) {
    ...
    return (uint64)CLOCK_IP_SIRC_FREQUENCY & Clock_Ip_u32EnableClock[((IP_SCG->SIRCCSR & SCG_SIRCCSR_SIRCEN_MASK) >> SCG_SIRCCSR_SIRCEN_SHIFT)];
}
...
static uint64 get_SIRCDIV1_CLK_Frequency(void) {
    ...
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[((IP_SCG->SIRCDIV & SCG_SIRCDIV_SIRCDIV1_MASK) >> SCG_SIRCDIV_SIRCDIV1_SHIFT)];
...
static uint64 get_SIRCDIV2_CLK_Frequency(void) {
    ...
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[((IP_SCG->SIRCDIV & SCG_SIRCDIV_SIRCDIV2_MASK) >> SCG_SIRCDIV_SIRCDIV2_SHIFT)];
    return (DivValue != 0U) ? (get_SIRC_CLK_Frequency() / DivValue) : 0U;
}
...
static uint64 get_FIRCDIV1_CLK_Frequency(void) {
    ...
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[((IP_SCG->FIRCDIV & SCG_FIRCDIV_FIRCDIV1_MASK) >> SCG_FIRCDIV_FIRCDIV1_SHIFT)];
...
static uint64 get_FIRCDIV2_CLK_Frequency(void) {
    ...
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[((IP_SCG->FIRCDIV & SCG_FIRCDIV_FIRCDIV2_MASK) >> SCG_FIRCDIV_FIRCDIV2_SHIFT)];
    return (DivValue != 0U) ? (get_FIRC_CLK_Frequency() / DivValue) : 0U;
}
...
static uint64 get_SOSCDIV1_CLK_Frequency(void) {
    ...
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[((IP_SCG->SOSCDIV & SCG_SOSCDIV_SOSCDIV1_MASK) >> SCG_SOSCDIV_SOSCDIV1_SHIFT)];
...
static uint64 get_SOSCDIV2_CLK_Frequency(void) {
    ...
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[((IP_SCG->SOSCDIV & SCG_SOSCDIV_SOSCDIV2_MASK) >> SCG_SOSCDIV_SOSCDIV2_SHIFT)];
    return (DivValue != 0U) ? (get_SOSC_CLK_Frequency() / DivValue) : 0U;
}
...
static uint64 get_SPLLDIV1_CLK_Frequency(void) {
    ...
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[((IP_SCG->SPLLDIV & SCG_SPLLDIV_SPLLDIV1_MASK) >> SCG_SPLLDIV_SPLLDIV1_SHIFT)];
...
static uint64 get_SPLLDIV2_CLK_Frequency(void) {
    ...
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[((IP_SCG->SPLLDIV & SCG_SPLLDIV_SPLLDIV2_MASK) >> SCG_SPLLDIV_SPLLDIV2_SHIFT)];
    return (DivValue != 0U) ? (get_SPLL_CLK_Frequency() / DivValue) : 0U;
}
#endif
...
static uint64 get_LPO_1K_CLK_Frequency(void) {
    ...
    return (get_LPO_32K_CLK_Frequency() >> 5U) & Clock_Ip_u32EnableGate[((IP_SIM->LPOCLKS & SIM_LPOCLKS_LPO1KCLKEN_MASK) >> SIM_LPOCLKS_LPO1KCLKEN_SHIFT)];
}
...
static uint64 get_SCS_CLK_Frequency(void) {
    ...
    return FreqTableSCS[((IP_SCG->CSR & SCG_CSR_SCS_MASK) >> SCG_CSR_SCS_SHIFT) & 0x7U]();       /*  Selector value */
}

/* Return CORE_CLK frequency */
static uint64 get_CORE_CLK_Frequency(void) {

    return get_SCS_CLK_Frequency() / ((((uint64)IP_SCG->CSR & (uint64)SCG_CSR_DIVCORE_MASK) >> (uint64)SCG_CSR_DIVCORE_SHIFT) + 1U);
}

/* Return SLOW_CLK frequency */
static uint64 get_BUS_CLK_Frequency(void) {

    return get_CORE_CLK_Frequency() / ((((uint64)IP_SCG->CSR & (uint64)SCG_CSR_DIVBUS_MASK) >> (uint64)SCG_CSR_DIVBUS_SHIFT) + 1U);
}

/* Return SLOW_CLK frequency */
static uint64 get_SLOW_CLK_Frequency(void) {

    return get_CORE_CLK_Frequency() / ((((uint64)IP_SCG->CSR & (uint64)SCG_CSR_DIVSLOW_MASK) >> (uint64)SCG_CSR_DIVSLOW_SHIFT) + 1U);
}

#if defined(CLOCK_IP_HAS_SCS_HSRUN_CLK)
/* Return SCS_HSRUN_CLK frequency */
static uint64 get_SCS_HSRUN_CLK_Frequency(void) {

    return FreqTableSCS[((IP_SCG->HCCR & SCG_HCCR_SCS_MASK) >> SCG_HCCR_SCS_SHIFT)]();       /*  Selector value */
}
#endif
#if defined(CLOCK_IP_HAS_CORE_HSRUN_CLK)
/* Return CORE_HSRUN_CLK frequency */
static uint64 get_CORE_HSRUN_CLK_Frequency(void) {

    return get_SCS_HSRUN_CLK_Frequency() / (((IP_SCG->HCCR & SCG_HCCR_DIVCORE_MASK) >> SCG_HCCR_DIVCORE_SHIFT) + 1U);
}
#endif
#if defined(CLOCK_IP_HAS_BUS_HSRUN_CLK)
/* Return SLOW_HSRUN_CLK frequency */
static uint64 get_BUS_HSRUN_CLK_Frequency(void) {

    return get_CORE_HSRUN_CLK_Frequency() / (((IP_SCG->HCCR & SCG_HCCR_DIVBUS_MASK) >> SCG_HCCR_DIVBUS_SHIFT) + 1U);
}
#endif
#if defined(CLOCK_IP_HAS_SLOW_HSRUN_CLK)
/* Return SLOW_HSRUN_CLK frequency */
static uint64 get_SLOW_HSRUN_CLK_Frequency(void) {
    ...
    return get_CORE_HSRUN_CLK_Frequency() / (((IP_SCG->HCCR & SCG_HCCR_DIVSLOW_MASK) >> SCG_HCCR_DIVSLOW_SHIFT) + 1U);
}
#endif

/* Return SCS_RUN_CLK frequency */
static uint64 get_SCS_RUN_CLK_Frequency(void) {

    return FreqTableSCS[((IP_SCG->RCCR & SCG_RCCR_SCS_MASK) >> SCG_RCCR_SCS_SHIFT) & 0x7U]();       /*  Selector value */
}

/* Return CORE_RUN_CLK frequency */
static uint64 get_CORE_RUN_CLK_Frequency(void) {

    return get_SCS_RUN_CLK_Frequency() / ((((uint64)IP_SCG->RCCR & (uint64)SCG_RCCR_DIVCORE_MASK) >> (uint64)SCG_RCCR_DIVCORE_SHIFT) + 1U);
}

/* Return SLOW_RUN_CLK frequency */
static uint64 get_BUS_RUN_CLK_Frequency(void) {

    return get_CORE_CLK_Frequency() / ((((uint64)IP_SCG->RCCR & (uint64)SCG_RCCR_DIVBUS_MASK) >> (uint64)SCG_RCCR_DIVBUS_SHIFT) + 1U);
}

/* Return SLOW_RUN_CLK frequency */
static uint64 get_SLOW_RUN_CLK_Frequency(void) {

    return get_CORE_CLK_Frequency() / ((((uint64)IP_SCG->RCCR & (uint64)SCG_RCCR_DIVSLOW_MASK) >> (uint64)SCG_RCCR_DIVSLOW_SHIFT) + 1U);
}


/* Return SCS_VLPR_CLK frequency */
static uint64 get_SCS_VLPR_CLK_Frequency(void) {

    return FreqTableSCS[((IP_SCG->VCCR & SCG_VCCR_SCS_MASK) >> SCG_VCCR_SCS_SHIFT) & 0x7U]();       /*  Selector value */
}

/* Return CORE_VLPR_CLK frequency */
static uint64 get_CORE_VLPR_CLK_Frequency(void) {

    return get_SCS_VLPR_CLK_Frequency() / ((((uint64)IP_SCG->VCCR & (uint64)SCG_VCCR_DIVCORE_MASK) >> (uint64)SCG_VCCR_DIVCORE_SHIFT) + 1U);
}

/* Return SLOW_VLPR_CLK frequency */
static uint64 get_BUS_VLPR_CLK_Frequency(void) {

    return get_CORE_VLPR_CLK_Frequency() / ((((uint64)IP_SCG->VCCR & (uint64)SCG_VCCR_DIVBUS_MASK) >> (uint64)SCG_VCCR_DIVBUS_SHIFT) + 1U);
}

/* Return SLOW_VLPR_CLK frequency */
static uint64 get_SLOW_VLPR_CLK_Frequency(void) {

    return get_CORE_VLPR_CLK_Frequency() / ((((uint64)IP_SCG->VCCR & (uint64)SCG_VCCR_DIVSLOW_MASK) >> (uint64)SCG_VCCR_DIVSLOW_SHIFT) + 1U);
}
...
static uint64 get_SCG_CLKOUT_CLK_Frequency(void) {
    ...
    return FreqTableScg[((IP_SCG->CLKOUTCNFG & SCG_CLKOUTCNFG_CLKOUTSEL_MASK) >> SCG_CLKOUTCNFG_CLKOUTSEL_SHIFT) & 0x7U]();       /*  Selector value */
}
...
static uint64 get_CLKOUT0_CLK_Frequency(void) {
    ...
    const uint64 EnableDivider[2U] = {CLOCK_IP_DISABLED,CLOCK_IP_ENABLED};

    uint64 Frequency = FreqTableClkOut[((IP_SIM->CHIPCTL & SIM_CHIPCTL_CLKOUTSEL_MASK) >> SIM_CHIPCTL_CLKOUTSEL_SHIFT)]();       /*  Selector value */
    Frequency &= EnableDivider[((IP_SIM->CHIPCTL & SIM_CHIPCTL_CLKOUTEN_MASK) >> SIM_CHIPCTL_CLKOUTEN_SHIFT)];                           /*  Divider enable/disable */
    Frequency /= ((((uint64)IP_SIM->CHIPCTL & (uint64)SIM_CHIPCTL_CLKOUTDIV_MASK) >> (uint64)SIM_CHIPCTL_CLKOUTDIV_SHIFT) + 1U);                                 /*  Apply divider value */
    return Frequency;
}
...
static uint64 get_ENET_CLK_Frequency(void) {
    ...
    uint64 DivValue = ((IP_PCC->PCCn[121U] & PCC_PCCn_PCD_MASK) >> PCC_PCCn_PCD_SHIFT) + 1U;
    uint64 MulValue = ((IP_PCC->PCCn[121U] & PCC_PCCn_FRAC_MASK) >> PCC_PCCn_FRAC_SHIFT) + 1U;
...
static uint64 get_LPTMR0_CLK_Frequency(void) {
    ...
    uint64 Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[64U] & PCC_PCCn_PCS_MASK) >> PCC_PCCn_PCS_SHIFT)]();       /*  Selector value */
    uint64 DivValue = (((uint64)IP_PCC->PCCn[64U] & (uint64)PCC_PCCn_PCD_MASK) >> (uint64)PCC_PCCn_PCD_SHIFT) + 1U;
    uint64 MulValue = (((uint64)IP_PCC->PCCn[64U] & (uint64)PCC_PCCn_FRAC_MASK) >> (uint64)PCC_PCCn_FRAC_SHIFT) + 1U;
...
static uint64 get_QSPI_SFIF_CLK_HYP_PREMUX_CLK_Frequency(void) {
    ...
    if (Clock_Ip_u32EnableGate[((IP_PCC->PCCn[118U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)] == CLOCK_IP_ENABLED)
    {
        ...
        if(Clkmodeselect  != 0U)
        {
            Frequency  = get_FIRCDIV1_CLK_Frequency() / ((DivConfig + (uint64)1U) * 2U) ;
        }
        else
        {
            #if defined(CLOCK_IP_HAS_SPLLDIV1_CLK)
            Frequency  = get_SPLLDIV1_CLK_Frequency() / ((DivConfig + (uint64)1U) * 2U) ;
            #else
...
static uint64 get_TRACE_CLK_Frequency(void) {
    ...
    uint64 DivValue = (((uint64)IP_SIM->CLKDIV4 & (uint64)SIM_CLKDIV4_TRACEDIV_MASK) >> (uint64)SIM_CLKDIV4_TRACEDIV_SHIFT) + 1U;
    uint64 MulValue = (((uint64)IP_SIM->CLKDIV4 & (uint64)SIM_CLKDIV4_TRACEFRAC_MASK) >> (uint64)SIM_CLKDIV4_TRACEFRAC_SHIFT) + 1U;
    return ((Frequency * MulValue)  / DivValue);
}
#endif
...
static uint64 PLL_VCO(SCG_Type const *Base)
{
    ...
    #if (defined (CLOCK_IP_DERIVATIVE_004) || defined(CLOCK_IP_DERIVATIVE_006) || defined(CLOCK_IP_DERIVATIVE_012))
    ...
    #endif
    Prediv = ((((uint64)Base->SPLLCFG & (uint64)SCG_SPLLCFG_PREDIV_MASK) >> (uint64)SCG_SPLLCFG_PREDIV_SHIFT) + 1U) << 1U;         /* Prediv * 2 */
    Mul = (((uint64)Base->SPLLCFG & (uint64)SCG_SPLLCFG_MULT_MASK) >> (uint64)SCG_SPLLCFG_MULT_SHIFT) + 16U;                     /* mfi */
