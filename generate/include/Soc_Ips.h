...
/**
* @brief Hardware errata for LPI2C: (e010792)
* @details e010792 LPI2C: Slave Transmit Data Flag may incorrectly read as one when TXCFG is zero.
*/
#define ERR_IPV_LPI2C_ERR010792         (STD_ON)

/**
* @brief Hardware errata for ERR_IPV_LPSPI_0001: (e051472)
* @details e051472 LPSPI: Disabling and enabling LPSPI would cause SR[REF] to assert
*/
#define ERR_IPV_LPSPI_0001      (STD_ON)
