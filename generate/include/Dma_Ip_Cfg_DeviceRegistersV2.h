...
#define DMA_IP_CFG_DEVICEREGISTERSV2_SW_MAJOR_VERSION                3
...
typedef struct {
  ...
  __IO uint8  reg_DCHPRI[DMA_DCHPRI_COUNT];           /**< Channel n Priority Register, array offset: 0x100, array step: 0x1 */
