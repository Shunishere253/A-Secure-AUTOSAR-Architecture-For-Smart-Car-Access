...
#define FTM_MCL_IP_CFG_SW_MAJOR_VERSION             3
...
/* Enable/Disable FTM Split common timebase API from MCL. */
#define FTM_MCL_SPLIT_COMMON_TIMEBASE_API           (STD_OFF)

/**
 * @brief      This define specifies the number of FTM modules present on the derivative. It is used for the
