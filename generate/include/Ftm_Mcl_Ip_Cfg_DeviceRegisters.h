...
#define FTM_MCL_IP_CFG_DEVICEREGISTERS_AR_RELEASE_MINOR_VERSION    7
#define FTM_MCL_IP_CFG_DEVICEREGISTERS_AR_RELEASE_REVISION_VERSION 0
#define FTM_MCL_IP_CFG_DEVICEREGISTERS_SW_MAJOR_VERSION            3
...
==================================================================================================*/
    ...
    /* Check if this header file and Std_Types.h file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Ftm_Mcl_Ip_Cfg_DeviceRegisters.h and Std_Types.h are different"
    #endif
#endif
