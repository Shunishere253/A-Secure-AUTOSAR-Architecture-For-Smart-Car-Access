...
/* Check if current file and IntCtrl_Ip header file are of the same vendor */
    ...
    #error "Platform_Ipw_Cfg.h and IntCtrl_Ip.h have different vendor ids"
#endif
/* Check if current file and IntCtrl_Ip header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Platform_Ipw_Cfg.h and IntCtrl_Ip.h are different"
#endif
/* Check if current file and IntCtrl_Ip header file are of the same Software version */
    ...
    #error "Software Version Numbers of Platform_Ipw_Cfg.h and IntCtrl_Ip.h are different"
#endif
#endif /*(PLATFORM_ENABLE_INT_CTRL == STD_ON)*/

#if (PLATFORM_ENABLE_MPU == STD_ON)
#if (CDD_PLATFORM_IPW_CFG_VENDOR_ID !=  CDD_PLATFORM_MPU_IP_VENDOR_ID)
    #error "Platform_Ipw_Cfg.h and Mpu_Ip.h have different vendor ids"
#endif
#if (( CDD_PLATFORM_IPW_CFG_AR_RELEASE_MAJOR_VERSION    !=  CDD_PLATFORM_MPU_IP_AR_RELEASE_MAJOR_VERSION) || \
     ( CDD_PLATFORM_IPW_CFG_AR_RELEASE_MINOR_VERSION    !=  CDD_PLATFORM_MPU_IP_AR_RELEASE_MINOR_VERSION) || \
     ( CDD_PLATFORM_IPW_CFG_AR_RELEASE_REVISION_VERSION !=  CDD_PLATFORM_MPU_IP_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Platform_Ipw_Cfg.h and Mpu_Ip.h are different"
#endif
#if (( CDD_PLATFORM_IPW_CFG_SW_MAJOR_VERSION !=  CDD_PLATFORM_MPU_IP_SW_MAJOR_VERSION) || \
     ( CDD_PLATFORM_IPW_CFG_SW_MINOR_VERSION !=  CDD_PLATFORM_MPU_IP_SW_MINOR_VERSION) || \
     ( CDD_PLATFORM_IPW_CFG_SW_PATCH_VERSION !=  CDD_PLATFORM_MPU_IP_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Platform_Ipw_Cfg.h and Mpu_Ip.h are different"
#endif
