...
#define UART_PBCFG_SW_MAJOR_VERSION_C              3
...
#endif
    (uint32)8000000U, /* Clock frequency */
...
*
*/
static const Uart_ChannelConfigType Uart_ChannelConfig_1 =
{
...
#endif
    (uint32)8000000U, /* Clock frequency */
    &Uart_Ipw_xHwConfigPB_1  /* Pointer to the hardware configuration */
};
/**
...
*
*/
static const Uart_ChannelConfigType Uart_ChannelConfig_2 =
{
...
#endif
    (uint32)8000000U, /* Clock frequency */
    &Uart_Ipw_xHwConfigPB_2  /* Pointer to the hardware configuration */
};
