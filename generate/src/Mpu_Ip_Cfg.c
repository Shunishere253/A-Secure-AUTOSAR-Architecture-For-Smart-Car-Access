...
const Mpu_Ip_RegionConfigType Mpu_Configuration_RegionConfig[1] =
{
    /* Region Configuration 0 */
    {
        0UL,
        4294967295UL,
        (MPU_SUPERVISOR_MODE_AS_USER_MODE << MPU_RGD_WORD2_M0SM_SHIFT) | \
        (MPU_SUPERVISOR_MODE_AS_USER_MODE << MPU_RGD_WORD2_M1SM_SHIFT) | \
        ...
        (MPU_USER_MODE_RWX << MPU_RGD_WORD2_M2UM_SHIFT) | \
        (MPU_USER_MODE_RWX << MPU_RGD_WORD2_M3UM_SHIFT),
        (0U),
        (0U)
    }
};
static const uint8 Mpu_Configuration_RegionNumber[1] =
{
    0U
};
